...
function drawText() {
    a.font = "40px Permanent Marker"; // Ukuran dan jenis font
    a.fillStyle = "Crimson"; // Warna teks
    a.textAlign = "center"; // Pusatkan teks
    a.fillText("DEYINNN", WIDTH / 2, HEIGHT / 2 + 50); // Atur posisi teks
}
